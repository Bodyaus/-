...
background = transform.scale(image.load("bestgab.png"), (win_width, win_height))

# Персонажі гри:
player = Player('beodj.png', 5, win_height - 80, 4)
platform = Player('platform.png', 5, win_height - 180, 4)
